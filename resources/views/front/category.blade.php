...
<body class="font-[Poppins] pb-[83px]">
	...
	<section id="Category-result" class="max-w-[1130px] mx-auto flex items-center flex-col gap-[30px] mt-[70px]">
        ...
        @forelse ( $category->news as $news )
            ...
            @empty
            {{-- <div id="search-cards" class="grid grid-cols-2 gap-[30px]"> --}}
                <div class="card w-full" style="color: #A3A6AE; text-align: center; padding: 20px; border: 1px solid #EEF0F7; border-radius: 20px;">
                    <div class="flex flex-col gap-[2px]">
						<h3 class="text-lg leading-[27px] font-bold">Belum Tersedia Artikel Terkait Kategori ini</h3>
